...
class CampaignFailedNotification extends React.Component {
  constructor(props){
    super(props);
      ...
      <Card>
        <div>
          <span className="notification-header">
            {title} sending failed, please try again.
          </span>
...
CampaignFailedNotification.propTypes = {
  notification: PropTypes.object,
  selectCategory: PropTypes.func,
  keywords: PropTypes.array
};

export default CampaignFailedNotification;
